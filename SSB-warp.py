...
import base64
import json
# i Am 4-0-4 >>> t.me/shayshayblack 🫶  - Telegram Channel - t.me/shayshayblack 🫶
warp_cidr = [
    "162.159.192.0/24",
    "162.159.193.0/24",
    "162.159.195.0/24",
...
def export_Hiddify(t_ips):
    config_prefix = f"warp://{t_ips[0]}?ifp=1-3&ifpm=m4#TEHRAN-404&&detour=warp://{t_ips[1]}?ifp=1-2&ifpm=m5#BERLIN-SSB"
...
with open("SSB-warp.json", "w") as op:
    op.write(
...
def export_SingBox(t_ips):
    ...
    with open("SSB-sing-box.json", "w") as f:
